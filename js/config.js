window.PAVIA_CONFIG = {
  version: '0.9.2', // bump +0.0.1 each release; after x.x.9 roll to x.(x+1).0 (e.g. 0.0.9 -> 0.1.0)
  siteName: 'Pavia',
  siteTitle: 'Pavia Lebanon',
  location: 'Beirut',
  deliveryArea: 'Lebanon',
  tagline: 'Modern elegant fashion',
  description: "Modern, elegant fashion from Beirut. Soft tailoring, ruffles and quiet neutrals, easy to wear, delivered to your door anywhere in Lebanon.",
